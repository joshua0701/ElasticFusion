...
//            so3StepMap["GeForce GTX 1070"] = std::pair<int, int>(256, 48);
            ...
            icpStepMap["GeForce GTX 1060"] = std::pair<int, int>(128, 144);
            rgbStepMap["GeForce GTX 1060"] = std::pair<int, int>(112, 80);
            rgbResMap["GeForce GTX 1060"] = std::pair<int, int>(96, 512);
            so3StepMap["GeForce GTX 1060"] = std::pair<int, int>(64, 80);

            icpStepMap["GeForce GTX 1060 3GB"] = std::pair<int, int>(128, 144);
            rgbStepMap["GeForce GTX 1060 3GB"] = std::pair<int, int>(112, 80);
            rgbResMap["GeForce GTX 1060 3GB"] = std::pair<int, int>(96, 512);
            so3StepMap["GeForce GTX 1060 3GB"] = std::pair<int, int>(64, 80);
